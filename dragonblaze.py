...
TOKEN = '5882781579:AAFhsNpVyfyW4oaIriewTApRdDGJiqxiHMM'  # BOT TOKEN

bot = telebot.TeleBot(TOKEN)

chat_id = '-1001675258280'  # CHAT ID DO CANAL ONDE DESEJA ENVIAR MSG
...
jogadas = [  # ADICIONE SEUS PALPITES PREDEFINIDOS AQUI, USE OS ABAIXO COMO EXEMPLO
    ['Preto','Preto', 'Vermelho', 'Vermelho'],  # PADRAO WILLIAM
    ['Preto', 'Vermelho', 'Vermelho', 'Vermelho'],  # PADRAO WILLIAM
    ['Preto', 'Preto', 'Preto', 'Preto', 'Preto'],  # PADRAO WILLIAM
    ['Preto', 'Preto', 'Vermelho', 'Vermelho', 'Preto'],  # PADRAO 2X2
    ['Vermelho', 'Vermelho', 'Preto', 'Preto', 'Vermelho'],  # PADRAO 2X2
    ['Preto', 'Vermelho', 'Preto', 'Vermelho', 'Preto'],  # PADRAO XADREZ
    ['Vermelho', 'Preto', 'Vermelho', 'Preto', 'Vermelho'],  # PADRAO XADREZ
    ['Vermelho', 'Vermelho', 'Vermelho', 'Preto', 'Vermelho'],  # PADRAO 3X1
    ['Preto', 'Preto', 'Preto', 'Vermelho', 'Preto'],  # PADRAO 3X1
    ['Vermelho', 'Vermelho', 'Preto', 'Vermelho'],  # PADRAO 2X1
    ['Preto', 'Preto', 'Vermelho', 'Preto', 'Preto'],  # PADRAO 2X1
    ['Preto', 'Preto', 'Preto', 'Preto', 'Preto'],  # PADRAO SURF
    ['Vermelho', 'Vermelho', 'Vermelho', 'Vermelho', 'Vermelho'],  # PADRAO SURF
    ['Vermelho'],  # PADRÃO ONE
    ['Branco']  # PADRAO ONE
]
